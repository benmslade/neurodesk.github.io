...
*The MEG data used in this tutorial can be found on OzStar: /fred/oz120/AEDAPT/MI02-sub-TEST/ses-TEST/meg*
...
Import raw file
```
raw_fname = '/fred/oz120/AEDAPT/MI02-sub-TEST/ses-TEST/meg/sub-TEST_ses-rest_task-rest_meg.fif'
...
```
emptyroom = '/fred/oz120/AEDAPT/MI02-sub-TEST/ses-TEST/meg/sub-TEST_ses-emptyroom_task-emptyroom_meg.fif'
 ...
 **Saving Images to File**
 ...
 plt.savefig('../.png', dpi = 300, edgecolor='none') #edgecolour=None to ensure the plot can be seen from the background
 ```
